...
set.seed(400046);
memory.limit(200000);
input.path <- "C:\\Users\\jjd264\\Documents\\Sims-Lpa-Heteroskedastic\\Datasets\\";
working.path <- "C:\\Users\\jjd264\\Documents\\Sims-Lpa-Heteroskedastic\\";
...
for (which.measurement.quality in 2) {
